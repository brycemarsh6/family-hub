...
// pure layout helpers — mission-12 (CV2), contract C2. Run with `npm test`,
// which pins TZ=America/Denver; the gauntlet re-runs this file directly under
// TZ=UTC to prove nothing here silently depends on the ambient zone.
//
